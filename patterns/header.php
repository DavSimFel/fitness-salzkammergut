...
<figure class="wp-block-image size-full is-resized" style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/Dachmarke_OnLight_dot.svg" alt="" style="width:auto;height:42px"/></figure>
<!-- /wp:image -->
